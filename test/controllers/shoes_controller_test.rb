...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { brand: @shoe.brand, category: @shoe.category, name: @shoe.name, price: @shoe.price, wesbite: @shoe.wesbite }
    end
  ...
  test "should update shoe" do
    patch :update, id: @shoe, shoe: { brand: @shoe.brand, category: @shoe.category, name: @shoe.name, price: @shoe.price, wesbite: @shoe.wesbite }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
